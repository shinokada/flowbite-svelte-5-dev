<script>
  ...
  import { IconOutline, ChevronDownOutline, UserCircleOutline, ArrowRightOutline } from 'flowbite-svelte-icons';
  let menu = [
...
<h2>Default mega menu</h2>

Use this example to show a list of links aligned on three columns inside the mega menu dropdown.

<div class='mt-8 border w-full mx-auto bg-gradient-to-r bg-white dark:bg-gray-900 p-6 h-[30rem] md:h-80'>
...
<Navbar let:hidden let:toggle>
  ...
  <NavUl {hidden}>
    ...
    <MegaMenu items={iconmenu} let:item>
...
<h2>Full width dropdown</h2>

Use this example to show a mega menu dropdown that spans the entire width of the document page.

<div class='mt-8 border w-full mx-auto bg-gradient-to-r bg-white dark:bg-gray-900 p-6 h-[55rem] md:h-[30rem] relative'>
<Navbar let:hidden let:toggle>
  <NavBrand href="/">
    <img src="/images/flowbite-svelte-icon-logo.svg" class="me-3 h-6 sm:h-9" alt="Flowbite Logo" />
    <span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white">Flowbite</span>
...
<h2>Full width with CTA</h2>

This example can be used to also show a CTA button or link next to the menu items inside the dropdown.

<div class='mt-8 border w-full mx-auto bg-gradient-to-r bg-white dark:bg-gray-900 p-6 h-[40rem] md:h-96 relative'>
<Navbar let:hidden let:toggle>
  <NavBrand href="/">
    <img src="/images/flowbite-svelte-icon-logo.svg" class="me-3 h-6 sm:h-9" alt="Flowbite Logo" />
    <span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white">Flowbite</span>

...
<div class='mt-8 border w-full mx-auto bg-gradient-to-r bg-white dark:bg-gray-900 p-6 flex h-72 items-end justify-center'>
...
<div class='mt-8 border w-full mx-auto bg-gradient-to-r bg-white dark:bg-gray-900 p-6 flex h-96 items-end justify-center'>
...
<div class='mt-8 border w-full mx-auto bg-gradient-to-r bg-white dark:bg-gray-900 p-6 flex h-96 items-end'>
...
<h2>Description popover</h2>

Show helpful information inside a popover when hovering over a question mark button.


<div class='mt-8 border w-full mx-auto bg-gradient-to-r bg-white dark:bg-gray-900 p-6 h-96'>
...
<h2>Progress popover</h2>

Show a progress bar with details inside a popover when hovering over a settings button.


<div class='mt-8 border w-full mx-auto bg-gradient-to-r bg-white dark:bg-gray-900 p-6 flex h-60 justify-center items-end'>
<Button id="progress">
...
<div class='mt-8 border w-full mx-auto bg-gradient-to-r bg-white dark:bg-gray-900 p-6 flex justify-center items-end h-44 gap-4'>
